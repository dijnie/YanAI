      ...
      <CardContent className="space-y-6 p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Configure a connection first, then query remote accounts and select accounts to import into the local pool.</p>
            </div>
          </div>
        ...
        <div className="rounded-xl bg-stone-50 px-4 py-3 text-sm leading-6 text-stone-500">
          ...
          <ul className="mt-1 list-inside list-disc space-y-0.5">
            <li>The page first loads configured CPA connections.</li>
            <li>Click "Sync" on a connection to fetch remote accounts and show them for selection.</li>
            <li>After confirmation, the backend downloads the selected access_tokens and imports them into the local pool.</li>
            <li>The frontend only polls import progress and does not download tokens directly.</li>
          </ul>
        </div>
      </CardContent>
    </Card>
