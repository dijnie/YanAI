        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Configure one proxy for outbound system requests. Changes apply immediately after saving.</p>
            </div>
          </div>
          ...
          <>
            <div className="space-y-2">
              ...
              <p className="text-sm text-stone-500">
                Leave blank to disable proxy. Use a full URL, for example `http://127.0.0.1:7890`, `http://username:password@127.0.0.1:7890`, or `socks5://127.0.0.1:7890`.
              </p>
            </div>
